...
/**
 * <h1>User Input for Editor</h1>
 * This class sets up the user input for the commands that manipulate the text in the
 * text editor system.  The class has a method that prompts the user for their
...
public class UserInputEditor {
	...
	CommandActionEditor runCommand = new CommandActionEditor();
	...
	/**
	 * Method that runs the user prompt until the user presses Q for quit.
	 *
	 */
